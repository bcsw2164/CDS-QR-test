/* ============================================================
   Radial Burst Flower — sketch.js (슬라이더 단일 생성기)
   ------------------------------------------------------------
   errorA/errorB 슬라이더로 방사형 다발 꽃잎 그래픽 하나를 생성해서
   보여준다. 실제 그래픽 생성 로직(형태 규칙)은 core.js의
   drawRadialBurstFlower 참고.
...
// ── 저장 ────────────────────────────────────────────────────
function saveImg() {
  saveCanvas(`radial_A${eA.toFixed(3)}_B${eB.toFixed(3)}`, 'png');
}
